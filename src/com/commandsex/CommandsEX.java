...
import com.commandsex.commands.CommandManager;
import com.commandsex.handlers.EventManager;
...
public class CommandsEX extends JavaPlugin {
    ...
    public void onEnable(){
        ...
        try {
            ...
            database.query("CREATE TABLE IF NOT EXISTS %prefix%userlangs (username varchar(50) NOT NULL, lang varchar(5) NOT NULL)" + (database.getType() == Database.DBType.MYSQL ? " ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='stores per-user selected plugin language'" : ""));
